...
func (tx *Tx) init() {
	tx.HistoricProcessInstance = NewHistoricProcessInstanceClient(tx.config)
...
// applies a query, for example: HistoricProcessInstance.QueryXXX(), the query will be executed
